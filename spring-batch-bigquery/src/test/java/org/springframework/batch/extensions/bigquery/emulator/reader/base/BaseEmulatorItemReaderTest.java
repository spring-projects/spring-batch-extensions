...
@Testcontainers
public abstract class BaseEmulatorItemReaderTest extends BaseEmulatorTest {

    @Container
    private static final GenericContainer<?> CONTAINER = BigQueryBaseDockerConfiguration.CONTAINER
            .withCommand("--project=" + PROJECT, "--log-level=debug", "--data-from-yaml=/reader-test.yaml")

...
class BigQueryLoadJobCsvItemWriterBuilderTest extends AbstractBigQueryTest {

	@Test
	void testBuild() throws IllegalAccessException, NoSuchFieldException {
		MethodHandles.Lookup csvWriterHandle = MethodHandles.privateLookupIn(BigQueryLoadJobCsvItemWriter.class,

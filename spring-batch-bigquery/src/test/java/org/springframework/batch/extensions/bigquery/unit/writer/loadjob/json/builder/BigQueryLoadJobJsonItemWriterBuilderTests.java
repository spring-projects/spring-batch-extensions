...
class BigQueryLoadJobJsonItemWriterBuilderTests extends AbstractBigQueryTest {

    @Test
    void testBuild() throws IllegalAccessException, NoSuchFieldException {
        MethodHandles.Lookup jsonWriterHandle = MethodHandles.privateLookupIn(BigQueryLoadJobJsonItemWriter.class, MethodHandles.lookup());

...
class BigQueryWriteApiCommitedJsonItemWriterBuilderTest {
    ...
    void testBigQueryWriteClient() throws IllegalAccessException, NoSuchFieldException {
        MethodHandles.Lookup handle = MethodHandles.privateLookupIn(BigQueryWriteApiCommitedJsonItemWriterBuilder.class, MethodHandles.lookup());
        ...
        BigQueryWriteClient actual = (BigQueryWriteClient) handle
                .findVarHandle(BigQueryWriteApiCommitedJsonItemWriterBuilder.class, "bigQueryWriteClient", BigQueryWriteClient.class)
                .get(builder);
    ...
    void testMarshaller() throws IllegalAccessException, NoSuchFieldException {
        ...
        JsonObjectMarshaller<PersonDto> actual = (JsonObjectMarshaller<PersonDto>) handle
                .findVarHandle(BigQueryWriteApiCommitedJsonItemWriterBuilder.class, "marshaller", JsonObjectMarshaller.class)
                .get(builder);
        Assertions.assertEquals(expected, actual);
    }
    ...
    void testApiFutureCallback() throws IllegalAccessException, NoSuchFieldException {
        ...
        ApiFutureCallback<AppendRowsResponse> actual = (ApiFutureCallback<AppendRowsResponse>) handle
                .findVarHandle(BigQueryWriteApiCommitedJsonItemWriterBuilder.class, "apiFutureCallback", ApiFutureCallback.class)
                .get(builder);
        Assertions.assertEquals(expected, actual);
    }
    ...
    void testBuild() throws IOException, IllegalAccessException, NoSuchFieldException {
        MethodHandles.Lookup handle = MethodHandles.privateLookupIn(BigQueryWriteApiCommitedJsonItemWriter.class, MethodHandles.lookup());
        ...
        BigQueryWriteClient actualWriteClient = (BigQueryWriteClient) handle
                .findVarHandle(BigQueryWriteApiCommitedJsonItemWriter.class, "bigQueryWriteClient", BigQueryWriteClient.class)
                .get(writer);
